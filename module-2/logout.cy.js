...
describe("Déconnexion", () => {
  ...
  // ──────────────────────────────────────────────
  it("SC15 - se déconnecter via le bouton Logout dans la sidebar", () => {
  ...
  // ──────────────────────────────────────────────
  it("SC16 - ne plus accéder au dashboard après déconnexion", () => {
    // 1. Se déconnecter
    cy.getBySel("sidenav-signout").click();
  ...
  // ──────────────────────────────────────────────
  it("SC17 - se reconnecter après une déconnexion", () => {
    // 1. Se déconnecter
    cy.getBySel("sidenav-signout").click();
